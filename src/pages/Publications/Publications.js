  ...
  const publications = [
    {
      ...
      pdfLink: "assets/docs/papers/Trading_Runtime_for_Energy_Efficiency.pdf" // Replace with actual PDF link
    },
    {
      ...
      pdfLink: "assets/docs/papers/On_the_Impact_of_PowerCap_in_Haskell_Java_and_Python.pdf" // Replace with actual PDF link
    }
  ];
